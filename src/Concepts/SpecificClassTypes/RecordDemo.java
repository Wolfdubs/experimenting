...
record EmployeeRecord(String name, int id) {   //This single line does exactly the same as all the boilerplate above
    ...
    public static void recordStaticMethod() {System.out.println("inside static method of record class");   //can define static methods too
...
public class RecordDemo {
    ...
    public static void main(String[] args) {
        ...
        //System.out.println(er.name);    //calling the autogenerated getter java creates for the record fields
